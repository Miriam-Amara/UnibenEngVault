...
class TestNotification(unittest.TestCase):
    ...
    def test_instance_type(self):
        """
        Test that object of Notification is an instance of Notification and BaseModel.
        """
    ...
    def test_instance_attributes(self):
        """
        Test that Notification class has instance attributes from BaseModel (parent)
        class.
        """
    ...
    def test_str_method(self):
        return_value = (f"[{self.notification.__class__.__name__}.{self.notification.id}] "
    ...
    def test_to_dict_method(self):
        ...
        notification_dict["created_at"] = self.notification.created_at.isoformat()
        notification_dict["updated_at"] = self.notification.updated_at.isoformat()
